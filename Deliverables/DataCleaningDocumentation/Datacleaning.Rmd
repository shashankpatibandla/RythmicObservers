...
output:
  html_document: 
    theme: cosmo
    toc: yes #table of contents automated
    code_folding: hide #hides code that is run
  word_document: 
  pdf_document: 
    toc: yes
  github_document:
...
#### Results
<p> Now we have a excel sheet for 2017 cleaned data and 2018 cleaned data. The 2017 cleaned data has 25 columns and 2874 rows. The 2018 cleaned data has 24 columns and 4261 rows </p>

<p> we need to futher clean some of the values like n/a or anomolies. As we know cleaning of data is a evergoing process. </p>
